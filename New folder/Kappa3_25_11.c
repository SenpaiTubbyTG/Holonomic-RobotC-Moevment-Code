#pragma config(Motor,  port3,           RightDrive,    tmotorNormal, openLoop, reversed )
#pragma config(Motor,  port2,           LeftDrive,     tmotorNormal, openLoop)
#pragma config(Motor,  port4,           ArmLT,         tmotorNormal, openLoop)
#pragma config(Motor,  port5,           ArmLB,         tmotorNormal, openLoop)
#pragma config(Motor,  port6,           ArmRT,         tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port7,           ArmRB,         tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port8,           ClawT,         tmotorNormal, openLoop)
#pragma config(Motor,  port9,           ClawB,         tmotorNormal, openLoop)
...
task usercontrol()
{
	...
	while (true)
	{
	  ...
	  motor[ArmRT] = (vexRT[Btn5D] - vexRT[Btn5U]) * 127;
	  motor[ArmRB] = (vexRT[Btn5D] - vexRT[Btn5U]) * 127;
    motor[ArmLT] = (vexRT[Btn5D] - vexRT[Btn5U]) * 127;
	  motor[ArmLB] = (vexRT[Btn5D] - vexRT[Btn5U]) * 127;

	  motor[ClawT] = (vexRT[Btn6D] - vexRT[Btn6U]) * 127;
    motor[ClawB] = (vexRT[Btn6D] - vexRT[Btn6U]) * 127;
	}
}
