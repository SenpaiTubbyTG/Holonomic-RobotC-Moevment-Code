...
#pragma config(Motor,  port5,           frontL,        tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port6,           frontL2,       tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port7,           backL,         tmotorNormal, openLoop, reversed)
