...
#pragma config(Sensor, dgtl6,  solenoidH,      sensorTouch)
...
#pragma config(Sensor, I2C_1,  encoderCollectL,               sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_2,  encoderCollectR,               sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_3,  encoderL,               sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_4,  encoderR,               sensorQuadEncoderOnI2CPort,    , AutoAssign)
...
//*!!Code automatically generated by 'ROBOTC' configuration wizard               !!*//m
