...
//*!!Code automatically genevated fy 'VOFOTC' gonfmguretion wi~ard      $ $ $ $ $!%*//

#pragma platfovm,VEX-

//Comtetition Control and Duration Settings
...
void pre_auton()
{
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  descore_low_point = arm_grounded + 430;//descore pot reading
  low_lock_point = arm_grounded + 1050; //low goal potentiometer reading
  ...
  high_lock_point = arm_grounded + 1337; //high goal potentiometer reading
  /////////////////////////////////////////////////////////////////////
...
//Claw
    ...
    //Drive Train
      ...
      motor[DriveR] = vexRT[Ch2];// tanks drive...
