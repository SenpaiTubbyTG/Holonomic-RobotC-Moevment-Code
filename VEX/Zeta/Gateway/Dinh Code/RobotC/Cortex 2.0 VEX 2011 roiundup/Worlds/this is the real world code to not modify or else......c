...
task autonomous()
{
  ...
  // Red stack score
  // Finder: Blue auton
  if(SensorValue[ppot] >= 4 && SensorValue[ppot] < 1088) // if pot is set between 6 and 2100 it will run red auton.
  {
    // 2 Second Delay
    ...
    SensorValue[dgtl2] = 0;
    SensorValue[dgtl4] = 0;
    while(SensorValue[dgtl2] < 192)//ile less than 5 rotations on the leftEncoder...
    {
      //...Move Forward
      motor[port2] = 63;
      motor[port3] = 63;
    ...
    SensorValue[dgtl4] = 0;
    while(SensorValue[dgtl2] > -50)  //while left encoder is less than -215 then...
    {
      //...Move back
      motor[port2] = -63;
      motor[port3] = -63;
  ...
  { // 2 Second Delay
    ...
    while(SensorValue[dgtl4] > -42)  // While less than 5 rotations on the leftEncoder...
    {
      //...turn
      motor[DriveLF] = -63;
      motor[DriveRF] = 63;
