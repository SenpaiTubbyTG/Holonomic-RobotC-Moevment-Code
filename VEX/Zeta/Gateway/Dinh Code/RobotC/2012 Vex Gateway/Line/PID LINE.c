...
int leftenc = (SensorValue[EncoderLeft]);
int rightenc = (SensorValue[EncoderRight]);
int count = (abs(rightenc) + abs(leftenc)/2);
int bothenc = (rightenc + leftenc)/2;
...
void clearenc();//clear the encoders
{
rightenc = 0;
leftenc = 0;
}
