...
void test_autonomous()
{
  ...
  wait1Msec(1000);
  DriveTime(200, -mid_power, inchToClick(4.0));
    wait1Msec(1000);
  MoveArm((mid_power*1.5), arm_top_goal_high);
    wait1Msec(1000);
  DriveTime(200, (mid_power - 10), inchToClick( 5.0));
    wait1Msec(1000);
  ...
  DriveTime(200, -mid_power, inchToClick( 12.0));
  MoveClaw(mid_power, claw_closed);
  MoveArm(low_power, arm_floor);
  MoveClaw(low_power,claw_open);
  TurnTime(550, -mid_power, -1);
