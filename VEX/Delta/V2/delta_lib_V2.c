...
/*Tube Detection*/
int tube_detection (int tube_distance) {
  if (SensorValue[DetectTube] < tube_distance) {
    return 0;
  }
  else {
    return 1;
...
void drive_suck_linetube(int speed, int suckspeed, int tubedistance, float distance) {
  SensorValue[EncoderL] = 0; //zeros encoders
  SensorValue[EncoderR] = 0;
  while (SensorValue[DetectTube] < tubedistance) {
