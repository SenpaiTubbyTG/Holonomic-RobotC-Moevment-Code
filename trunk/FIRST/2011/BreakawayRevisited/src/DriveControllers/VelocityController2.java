...
public class VelocityController2 implements IUtility{
    ...
    private class VelocityControllerTask extends TimerTask {
        ...
        private VelocityController2 m_controller;

        public VelocityControllerTask(VelocityController2 controller) {
            if (controller == null) {
                throw new NullPointerException("Given VelocityController2 was null");
            }
     ...
     */
    public VelocityController2(double Kp, double Ki, double Kd,
    ...
    /**
     * Set the setpoint for the VelocityController2
    ...
    /**
     * Returns the current setpoint of the VelocityController2
    ...
    /**
     * Begin running the VelocityController2
     */
    ...
    /**
     * Return true if VelocityController2 is enabled.
     */
