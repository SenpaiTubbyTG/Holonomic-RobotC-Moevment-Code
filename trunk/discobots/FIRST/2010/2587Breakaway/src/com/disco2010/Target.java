...
public class Target {
    ...
    public double getDistance()
    {
        ...
        if(m_majorRadius == m_minorRadius)
            distance = m_majorRadius*-53.83875513+17.42134927;
        else
            distance = (m_minorRadius+m_majorRadius)/2*-53.83875513+17.42134927;
        return distance;
    }
    ...
    public static Target[] findCircularTargets(ColorImage image) throws NIVisionException { //include gregs other parameters?
        ...
        for (int i = 0; i < results.length; i++) {
            ...
            target.m_yMax = (double)height/width;
