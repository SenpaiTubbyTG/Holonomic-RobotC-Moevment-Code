...
//
// Global variables
int cpStart=2100; // was 600;
int arm_top_goal_high = 3289;
int arm_top_goal_low = 3000; // was 2900
int arm_low_goal = 3006;
int arm_base = 2470;
int arm_floor = 2170;
int claw_wide = 2300;
int claw_open = 3000;  // was 1348;
int claw_mid = 3200;
int claw_closed = 3580; // was 1750; // was 1800
int low_power = 32;
int mid_power = 64;
int medium_power = 96;
int high_power = 127;
...
void pre_auton()
{
   ...
   cpStart = 2100; // Set to 600 as initial value
...
void test_autonomous()
{
  ...
  // .....................................................................................
  MoveClaw(low_power, claw_open);
  wait1Msec(1000);
  MoveClaw(mid_power, claw_wide);
    wait1Msec(1000);
  MoveClaw(mid_power, claw_closed);
    wait1Msec(1000);
  DriveTime(200, -mid_power, inchToClick(3.0)); // drive back 4 inches
    wait1Msec(1000);
  MoveArm((mid_power*1), arm_top_goal_high);
  motor[arm] = low_power;
  motor[arm2] = low_power;
  DriveTime(200, (mid_power - 10), inchToClick( 5.0)); // drive up 6 inches
    wait1Msec(1000);
  MoveArm(0, arm_top_goal_low);
  motor[arm] = low_power;
  motor[arm2] = low_power;

  MoveClaw(mid_power, claw_open);
  DriveTime(200, -mid_power, inchToClick( 11.0));
  wait1Msec(1000);
  MoveClaw(mid_power, claw_closed);
  motor[arm] = 0;
  motor[arm2] = 0;
  MoveArm(low_power, arm_floor);
      wait1Msec(1000);
  MoveClaw(low_power,claw_open);
  TurnTime(550, -mid_power, -1); // turn to pick up 4 tubes
  DriveTime(200, (mid_power*0.8), inchToClick( 8.0));
  MoveClaw(high_power, claw_closed);
  MoveArm(high_power, arm_low_goal);
  TurnTime(100, -mid_power, -1); // turn to goal
  move(0,0,0);
