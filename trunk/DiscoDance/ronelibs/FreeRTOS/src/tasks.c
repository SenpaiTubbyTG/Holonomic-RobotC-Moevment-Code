...
//			sprintf(text, "FreeRTOS error %d.  Could not create task %s", val, pcName);
//			serial_send_string_crlf(text);
		}
	} else {
		// error. print a message
//		sprintf(text, "too many tasks, max %d.  Could not create task %s", SYS_MAX_TASK_NUM, pcName);
//		serial_send_string_crlf(text);
