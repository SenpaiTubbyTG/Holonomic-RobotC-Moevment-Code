...
void pre_auton()
{
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  descore_low_point = arm_grounded + 300;    low_lock_point = arm_grounded + 990; //low goal potentiometer reading
  //sets the low lock point based on the starting potentiometer point



  /////////////////////////////////////
  descore_high_point = arm_grounded + 10;//<<<<---------------------------------------------------run debugger in tele op and see what this value is,
  //put that value where the XXXXX's are
  ////////////////////////////////////////



  high_lock_point = arm_grounded + 1275; //high goal potentiometer reading
  /////////////////////////////////////////////////////////////////////
...
task autonomous()
{
  ...
  { // 2 Second Delay
    ...
    while(SensorValue[dgtl2] > - 37)  // While less than 5 rotations on the leftEncoder...
    {
      //...turn left
      motor[DriveLF] = 63;
      motor[DriveRF] = -63;
    ...
    SensorValue[dgtl2] = 0;
    SensorValue[dgtl4] = 0;
    while(SensorValue[dgtl4] < 180) //while the right encoder is less than 195 then...
    {
      //...Move Forward
      motor[port2] = 63;
      motor[port3] = 63;
    ...
    motor[port10] = 0;
    wait1Msec(1);
    while(SensorValue[dgtl4] > -100)  //while left encoder is less than -215 then...
    {
      //...Move back
      motor[port2] = -63;
      motor[port3] = -63;
